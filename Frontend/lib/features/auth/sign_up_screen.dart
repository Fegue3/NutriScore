...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final result = await AuthApi.I.signUp(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Padding(
                  ...
                  child: Column(children: [
                    ...
                    Text('Criar conta', style: tt.headlineSmall?.copyWith(color: cs.onSurface, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 4),
                    Text('Junte-se ao NutriScore', style: tt.bodyMedium?.copyWith(color: cs.onSurface.withValues(alpha: .7))),
                  ]),
                ),
                Container(
                  ...
                  child: Form(
                    ...
                    child: Column(children: [
                      TextFormField(
                        ...
                        decoration: _inputDecoration(label: 'Nome (opcional)'),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          Text('Já tem conta?', style: tt.bodyMedium?.copyWith(color: cs.onSurface.withValues(alpha: .8))),
